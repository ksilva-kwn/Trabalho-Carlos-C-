...
void cadastrarDependente()
{
    ...
    cout << "Insira o nome(Utilize ' _ ' como espaÃ§o): ";
    ...
    cout << "O codigo do Dependente Ã©: " << cadastrarDependenteStruct.codigo << endl;
...
void cadastrarVisitante()
{
    ...
    cout << "O cÃ³digo do visitante Ã©: " << cadastrarVisitanteStruct.codigo;
...
int alterarDadosAssociados(const char *nomeArquivo)
{
    ...
    cout << "Digite o cÃ³digo do associado que deseja alterar: ";
    cin >> codigoAssociado;
...
void salvarDadosAssociadosEmArquivo()
{
    fstream arquivo("dadosAssociados.txt", ios::out); // Abre o arquivo para escrita, truncando o conteúdo existente
...
void salvarDadosDependentesEmArquivo()
{
    fstream arquivo("dadosDependentes.txt", ios::out);
...
void salvarDadosVisitantesEmArquivo()
{
    fstream arquivo("dadosVisitante.txt", ios::out);
...
void carregarDadosDoArquivo()
{
    fstream arquivoA, arquivoD, arquivoV, arquivoRV;
    arquivoA.open("dadosAssociados.txt", fstream::in | fstream::app);
    arquivoD.open("dadosDependentes.txt", fstream::in | fstream::app);
    arquivoV.open("dadosVisitante.txt", fstream::in | fstream::app);
}
